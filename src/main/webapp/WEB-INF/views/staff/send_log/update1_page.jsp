...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=3950"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/send_log/update1_submit',
		data:{
			"id":'${data.id}',
			"title":title,
			"psIntro":psIntro,
