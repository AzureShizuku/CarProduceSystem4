...
<title>新增-配送单</title>
<meta name="keywords" content="新增-配送单">
<meta name="description" content="新增-配送单">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="psIntroParentContent">
								...
								<input type="text" value="" placeholder="请输入配送说明" id="psIntro" class="form-control">
							</div>
							<div class="form-group" id="addressParentContent">
								<label>配送地址<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入配送地址" id="address" class="form-control">
							</div>
							<div class="form-group" id="contactNameParentContent">
								<label>联系人<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入联系人" id="contactName" class="form-control">
							</div>
							<div class="form-group" id="contactCelParentContent">
								<label>联系电话<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入联系电话" id="contactCel" class="form-control">
							</div>
							<div class="form-group" id="driverNameParentContent">
								<label>司机<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入司机" id="driverName" class="form-control">
							</div>
							<div class="form-group" id="driverCelParentContent">
								<label>副驾驶<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入副驾驶" id="driverCel" class="form-control">
							</div>
							<div class="form-group" id="driverName2ParentContent">
								<label>司机电话<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入司机电话" id="driverName2" class="form-control">
							</div>
							<div class="form-group" id="driverCel2ParentContent">
								<label>副驾驶电话<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入副驾驶电话" id="driverCel2" class="form-control">
							</div>
							<div class="form-group" id="psDetailParentContent">
								<label>配送单详情<span style="color:red">(*必填)</span></label>
								<div id="psDetail" class="dropzone" data-id="psDetail" max-num="1" file-type="4" max-size="1000" init-val=""></div>
							</div>
							<div class="form-group" id="totalAmountParentContent">
								<label>价值总额<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入价值总额" id="totalAmount" class="form-control">
							</div>
							<div class="form-group" id="psDateParentContent">
								<label>配送日期<span style="color:red">(*必填)</span></label>
								<input type="text" class="form-control Wdate"  readonly="readonly"  value=""  onFocus="WdatePicker({startDate: '%y-%M-%d' ,dateFmt:'yyyy-MM-dd',alwaysUseStartDate: true })"  placeholder="请输入配送日期" id="psDate">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=3078"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/send_log/add1_submit',
		data:{
			"title":title,
			"psIntro":psIntro,
			"address":address,
		...
		success: function(result) {
			if(result.code == 0){
				...
				alert(result.msg);
				window.location.href="${pageContext.request.contextPath}/staff/send_log";
			}
		}
	});
}
