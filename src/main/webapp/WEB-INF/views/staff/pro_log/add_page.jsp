...
<title>新增-生产记录</title>
<meta name="keywords" content="新增-生产记录">
<meta name="description" content="新增-生产记录">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="checkIntroParentContent">
								...
								<input type="text" value="" placeholder="请输入质检说明" id="checkIntro" class="form-control">
							</div>
							<div class="form-group" id="checkFileParentContent">
								<label>质检证书<span style="color:red">(*必填)</span></label>
								<div id="checkFile" class="dropzone" data-id="checkFile" max-num="1" file-type="4" max-size="1000" init-val=""></div>
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2112"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/pro_log/add_submit',
		data:{
			"stockId":stockId,
