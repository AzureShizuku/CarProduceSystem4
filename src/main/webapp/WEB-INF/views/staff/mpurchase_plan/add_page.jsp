...
<title>新增-物料采购计划</title>
<meta name="keywords" content="新增-物料采购计划">
<meta name="description" content="新增-物料采购计划">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="pdetailParentContent">
								<label>采购详情<span style="color:red">(*必填)</span></label>
							...
							<div class="form-group" id="totalAmountParentContent">
								<label>采购总额<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入采购总额(请输入数字)" id="totalAmount" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1256"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/mpurchase_plan/add_submit',
		data:{
			"title":title,
			"pintro":pintro,
			"pdetail":pdetail,
		...
		success: function(result) {
			if(result.code == 0){
				...
				alert(result.msg);
				window.location.href="${pageContext.request.contextPath}/staff/mpurchase_plan";
			}
		}
	});
}
