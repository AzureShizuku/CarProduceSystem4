...
<title>修改-物料采购计划</title>
<meta name="keywords" content="修改-物料采购计划">
<meta name="description" content="修改-物料采购计划">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="totalAmountParentContent">
								...
								<input type="text" value="${data.totalAmount}" placeholder="请输入采购总额(请输入数字)" id="totalAmount" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8689"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/mpurchase_plan/update_submit',
		data:{
			"id":'${data.id}',
			"title":title,
			"pintro":pintro,
