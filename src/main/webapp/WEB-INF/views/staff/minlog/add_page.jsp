...
<title>新增-物料入库单</title>
<meta name="keywords" content="新增-物料入库单">
<meta name="description" content="新增-物料入库单">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="numParentContent">
								...
								<input type="text" value="" placeholder="请输入入库数量(请输入数字)" id="num" class="form-control">
							</div>
							<div class="form-group" id="inRemarkParentContent">
								<label>入库备注<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入入库备注" id="inRemark" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1320"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/minlog/add_submit',
		data:{
