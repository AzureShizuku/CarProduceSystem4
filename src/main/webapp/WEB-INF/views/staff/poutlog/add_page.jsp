...
<title>新增-出库单</title>
<meta name="keywords" content="新增-出库单">
<meta name="description" content="新增-出库单">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="outNumParentContent">
								...
								<input type="text" value="" placeholder="请输入出库数量(请输入数字)" id="outNum" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4388"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/poutlog/add_submit',
		data:{
			"stockId":stockId,
			"outNum":outNum,
			"remark":remark
