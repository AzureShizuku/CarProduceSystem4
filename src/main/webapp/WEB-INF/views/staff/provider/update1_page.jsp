...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=9768"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/provider/update1_submit',
		data:{
			"id":'${data.id}',
			"loginName":loginName,
			"password":password,
