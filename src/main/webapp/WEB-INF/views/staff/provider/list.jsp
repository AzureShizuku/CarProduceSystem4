			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					...
					<div class="row"  style="margin-top:5px;padding-left: 15px;">
						<a href="${pageContext.request.contextPath}/staff/provider/add1" class="btn btn-primary">新增</a>
					</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8308"></script>
...
function ajaxList(page) {
	...
	$.ajax({
		type : 'get',
		url : "${pageContext.request.contextPath}/staff/provider/queryList",
		data : {
			"page":page,
			"loginName":loginName,
			"gysdj":gysdj
		...
		success : function(result) {
			...
			for (var i = 0; i < rows.length; i++) {
				...
				html+='<td>'+gysdjVal+'</td>';
				html+='<td>';
				html+='<a href="${pageContext.request.contextPath}/staff/provider/update1?id='+rows[i].provider.id+'" class="btn btn-success btnStyle">修改</a>';
				html+='</td>';
				html+='</tr>';
			}
			if (rows.length == 0) {
...
function ajaxCount() {
	...
	$.ajax({
		type : 'get',
		url : "${pageContext.request.contextPath}/staff/provider/queryCount",
		async: false,
		data : {
			"loginName":loginName,
			"gysdj":gysdj
