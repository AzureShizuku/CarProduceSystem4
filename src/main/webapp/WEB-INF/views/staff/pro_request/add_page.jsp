...
<title>新增-生产请求</title>
<meta name="keywords" content="新增-生产请求">
<meta name="description" content="新增-生产请求">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="needNumParentContent">
								...
								<input type="text" value="" placeholder="请输入需求数量(请输入数字)" id="needNum" class="form-control">
							</div>
							...
							<div class="form-group" id="requestIntroParentContent">
								...
								<input type="text" value="" placeholder="请输入请求说明" id="requestIntro" class="form-control">
							</div>
							<div class="form-group" id="requestFileParentContent">
								<label>附件<span style="color:red">(*必填)</span></label>
								<div id="requestFile" class="dropzone" data-id="requestFile" max-num="1" file-type="4" max-size="1000" init-val=""></div>
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=7531"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/pro_request/add_submit',
		data:{
			"stockId":stockId,
			"needNum":needNum,
			"jfDate":jfDate,
