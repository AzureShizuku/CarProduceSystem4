...
<title>接受申请-生产请求</title>
<meta name="keywords" content="接受申请-生产请求">
<meta name="description" content="接受申请-生产请求">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=7500"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/pro_request/jssq_submit',
		data:{
			"id":'${data.id}',
