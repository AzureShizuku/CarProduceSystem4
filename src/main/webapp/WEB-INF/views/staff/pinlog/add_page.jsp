...
<title>新增-入库记录</title>
<meta name="keywords" content="新增-入库记录">
<meta name="description" content="新增-入库记录">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="numParentContent">
								...
								<input type="text" value="" placeholder="请输入商品数(请输入数字)" id="num" class="form-control">
							</div>
							<div class="form-group" id="remarkParentContent">
								<label>入库备注<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入入库备注" id="remark" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1795"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/pinlog/add_submit',
		data:{
			"stockId":stockId,
			"num":num,
			"remark":remark
