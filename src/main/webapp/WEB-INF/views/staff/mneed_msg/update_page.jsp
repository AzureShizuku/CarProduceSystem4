...
<title>修改-物料需求单</title>
<meta name="keywords" content="修改-物料需求单">
<meta name="description" content="修改-物料需求单">
				...
				<div class="ibox-content">
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="nintroParentContent">
								<label>需求说明<span style="color:red">(*必填)</span></label>
								<input type="text" value="${data.nintro}" placeholder="请输入需求说明" id="nintro" class="form-control">
							</div>
							<div class="form-group" id="ndetailParentContent">
								<label>需求详情<span style="color:red">(*必填)</span></label>
								<div id="ndetail" class="dropzone" data-id="ndetail" max-num="1" file-type="4" max-size="1000" init-val="${data.ndetail}"></div>
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8513"></script>
...
function submitData(){
	...
	var ndetail=getFileVal2('ndetail')
	var jfDate= $('#jfDate').val();
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/mneed_msg/update_submit',
		data:{
			"id":'${data.id}',
			"title":title,
			"nintro":nintro,
		...
		success: function(result) {
			if(result.code == 0){
				...
				alert(result.msg);
				window.location.href="${pageContext.request.contextPath}/staff/mneed_msg";
			}
		}
	});
}
