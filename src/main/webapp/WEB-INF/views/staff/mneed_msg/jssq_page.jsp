...
<title>接受申请-物料需求单</title>
<meta name="keywords" content="接受申请-物料需求单">
<meta name="description" content="接受申请-物料需求单">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8343"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/mneed_msg/jssq_submit',
		data:{
			"id":'${data.id}',
