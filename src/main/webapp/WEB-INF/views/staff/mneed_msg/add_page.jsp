...
<title>新增-物料需求单</title>
<meta name="keywords" content="新增-物料需求单">
<meta name="description" content="新增-物料需求单">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="nintroParentContent">
								...
								<input type="text" value="" placeholder="请输入需求说明" id="nintro" class="form-control">
							</div>
							<div class="form-group" id="ndetailParentContent">
								<label>需求详情<span style="color:red">(*必填)</span></label>
								<div id="ndetail" class="dropzone" data-id="ndetail" max-num="1" file-type="4" max-size="1000" init-val=""></div>
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2076"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/mneed_msg/add_submit',
		data:{
			"title":title,
			"nintro":nintro,
			"ndetail":ndetail,
