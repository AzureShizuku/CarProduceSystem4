...
<title>新增-物料出库</title>
<meta name="keywords" content="新增-物料出库">
<meta name="description" content="新增-物料出库">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="numParentContent">
								...
								<input type="text" value="" placeholder="请输入出库数量(请输入数字)" id="num" class="form-control">
							</div>
							<div class="form-group" id="remarkParentContent">
								<label>出库备注<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入出库备注" id="remark" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=5172"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/moutlog/add_submit',
		data:{
		...
		success: function(result) {
			if(result.code == 0){
				...
				alert(result.msg);
				window.location.href="${pageContext.request.contextPath}/staff/moutlog";
			}
		}
	});
}
