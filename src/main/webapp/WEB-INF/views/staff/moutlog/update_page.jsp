...
<title>修改-物料出库</title>
<meta name="keywords" content="修改-物料出库">
<meta name="description" content="修改-物料出库">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="numParentContent">
								...
								<input type="text" value="${data.num}" placeholder="请输入出库数量(请输入数字)" id="num" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=0987"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/moutlog/update_submit',
		data:{
			"id":'${data.id}',
