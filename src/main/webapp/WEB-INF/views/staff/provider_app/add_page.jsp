...
<title>新增-供应商申请</title>
<meta name="keywords" content="新增-供应商申请">
<meta name="description" content="新增-供应商申请">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="nameParentContent">
								...
								<input type="text" value="" placeholder="请输入厂家名" id="name" class="form-control">
							</div>
							...
							<div class="form-group" id="celcontact_ParentContent">
								...
								<input type="text" value="" placeholder="请输入联系电话" id="celcontact_" class="form-control">
							</div>
							...
							<div class="form-group" id="gmParentContent">
								...
								<input type="text" value="" placeholder="请输入厂家规模" id="gm" class="form-control">
							</div>
							<div class="form-group" id="proNamesParentContent">
								<label>生产产品<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入生产产品" id="proNames" class="form-control">
							</div>
							<div class="form-group" id="proDetailParentContent">
								<label>产品报价单<span style="color:red">(*必填)</span></label>
								<div id="proDetail" class="dropzone" data-id="proDetail" max-num="1" file-type="4" max-size="1000" init-val=""></div>
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4163"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/provider_app/add_submit',
		data:{
			"name":name,
