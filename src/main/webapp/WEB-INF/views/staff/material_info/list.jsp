			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					...
					<div class="row"  style="margin-top:5px;padding-left: 15px;">
						<a href="${pageContext.request.contextPath}/staff/material_info/add1" class="btn btn-primary">新增</a>
					</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=3358"></script>
...
function ajaxList(page) {
	...
	$.ajax({
		type : 'get',
		url : "${pageContext.request.contextPath}/staff/material_info/queryList",
		data : {
			"page":page,
			"mno":mno,
			"mname":mname
		...
		success : function(result) {
			...
			for (var i = 0; i < rows.length; i++) {
				...
				html+='<td>￥'+priceVal+'</td>';
				html+='<td>';
				html+='<a href="${pageContext.request.contextPath}/staff/material_info/update1?id='+rows[i].materialInfo.id+'" class="btn btn-success btnStyle">修改</a>';
				html+='</td>';
				html+='</tr>';
			}
			if (rows.length == 0) {
...
function ajaxCount() {
	...
	$.ajax({
		type : 'get',
		url : "${pageContext.request.contextPath}/staff/material_info/queryCount",
		async: false,
		data : {
			"mno":mno,
			"mname":mname
