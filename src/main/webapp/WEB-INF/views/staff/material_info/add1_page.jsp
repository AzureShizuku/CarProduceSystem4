...
<title>新增-物料台账</title>
<meta name="keywords" content="新增-物料台账">
<meta name="description" content="新增-物料台账">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="mnoParentContent">
								...
								<input type="text" value="" placeholder="请输入物料编号" id="mno" class="form-control">
							</div>
							<div class="form-group" id="mnameParentContent">
								<label>物料名<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入物料名" id="mname" class="form-control">
							</div>
							<div class="form-group" id="mintroParentContent">
								<label>物料介绍<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入物料介绍" id="mintro" class="form-control">
							</div>
							<div class="form-group" id="stockNumParentContent">
								<label>库存量<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入库存量(请输入数字)" id="stockNum" class="form-control">
							</div>
							...
							<div class="form-group" id="priceParentContent">
								...
								<input type="text" value="" placeholder="请输入参考价格(请输入数字)" id="price" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2198"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/material_info/add1_submit',
		data:{
			"mno":mno,
			"mname":mname,
			"mintro":mintro,
