...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1510"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/stock_msg/add1_submit',
		data:{
			"proNo":proNo,
			"proName":proName,
			"gg":gg,
