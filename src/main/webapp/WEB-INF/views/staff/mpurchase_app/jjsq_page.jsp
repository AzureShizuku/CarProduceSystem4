...
<title>拒绝申请-物料申购单</title>
<meta name="keywords" content="拒绝申请-物料申购单">
<meta name="description" content="拒绝申请-物料申购单">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=0839"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/mpurchase_app/jjsq_submit',
		data:{
			"id":'${data.id}',
			"shbz":shbz
		},
