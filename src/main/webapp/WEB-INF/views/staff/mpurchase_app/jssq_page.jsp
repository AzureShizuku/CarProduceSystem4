...
<title>接受申请-物料申购单</title>
<meta name="keywords" content="接受申请-物料申购单">
<meta name="description" content="接受申请-物料申购单">
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="shbzParentContent">
								<label>审核备注<span style="color:red">(*必填)</span></label>
								<input type="text" value="${data.shbz}" placeholder="请输入审核备注" id="shbz" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2495"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/mpurchase_app/jssq_submit',
		data:{
			"id":'${data.id}',
			"shbz":shbz
		},
