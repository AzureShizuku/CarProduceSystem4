...
<title>新增-物料申购单</title>
<meta name="keywords" content="新增-物料申购单">
<meta name="description" content="新增-物料申购单">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="noParentContent">
								<label>物料编号</label>
								<input type="text" value="" placeholder="请输入物料编号" id="no" class="form-control">
							</div>
							...
							<div class="form-group" id="mtypeParentContent">
								...
								<input type="text" value="" placeholder="请输入型号" id="mtype" class="form-control">
							</div>
							<div class="form-group" id="pintroParentContent">
								<label>采购说明<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入采购说明" id="pintro" class="form-control">
							</div>
							<div class="form-group" id="mstandardParentContent">
								<label>技术标准<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入技术标准" id="mstandard" class="form-control">
							</div>
							<div class="form-group" id="numParentContent">
								<label>数量<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入数量(请输入数字)" id="num" class="form-control">
							</div>
							...
							<div class="form-group" id="planPriceParentContent">
								...
								<input type="text" value="" placeholder="请输入预购价格(请输入数字)" id="planPrice" class="form-control">
							</div>
							...
							<div class="form-group" id="dhDateParentContent">
								...
								<input type="text" class="form-control Wdate"  readonly="readonly"  value=""  onFocus="WdatePicker({startDate: '%y-%M-%d' ,dateFmt:'yyyy-MM-dd',alwaysUseStartDate: true })"  placeholder="请输入到货日期" id="dhDate">
							</div>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/mpurchase_app/add_submit',
		data:{
			"no":no,
			"name":name,
			"gg":gg,
