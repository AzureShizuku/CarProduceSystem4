...
<title>新增-销售计划</title>
<meta name="keywords" content="新增-销售计划">
<meta name="description" content="新增-销售计划">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="planNameParentContent">
								...
								<input type="text" value="" placeholder="请输入计划名" id="planName" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=6749"></script>
...
function getEditVal(name){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/sale_plan/add_submit',
		data:{
			"planName":planName,
