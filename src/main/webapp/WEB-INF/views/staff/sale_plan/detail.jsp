...
<title>销售计划-详情页</title>
<meta name="keywords" content="销售计划-详情页">
<meta name="description" content="销售计划-详情页">
						...
						<div class="table-responsive">
							<table class="table  table-striped table-bordered  table-hover">
								...
								<tbody id="detailBody">
									<tr>
										<th width="10%">计划名</th>
										<th width="70%"class="thContentStyle" >${detail.salePlan.planName}</th>
									</tr>
									<tr>
										<th width="10%">计划详情</th>
										<th width="70%"class="thContentStyle" ><div style="width:70%;">${detail.salePlan.planDetail}</div></th>
									</tr>
									<tr>
										<th width="10%">开始日期</th>
										<th width="70%"class="thContentStyle" >${detail.salePlan.ksDate}</th>
									</tr>
									<tr>
										<th width="10%">结束日期</th>
										<th width="70%"class="thContentStyle" >${detail.salePlan.jsDate}</th>
									</tr>
									<tr>
										<th width="10%">创建日期</th>
										<th width="70%"class="thContentStyle" >${detail.salePlan.createDate}</th>
									</tr>
								</tbody>
							</table>
						</div>
