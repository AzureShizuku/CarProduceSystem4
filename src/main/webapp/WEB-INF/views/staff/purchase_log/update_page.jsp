...
<title>修改-订货单</title>
<meta name="keywords" content="修改-订货单">
<meta name="description" content="修改-订货单">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="slParentContent">
								...
								<input type="text" value="${data.sl}" placeholder="请输入数量(请输入数字)" id="sl" class="form-control">
							</div>
							<div class="form-group" id="priceParentContent">
								<label>采购价格<span style="color:red">(*必填)</span></label>
								<input type="text" value="${data.price}" placeholder="请输入采购价格(请输入数字)" id="price" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=5731"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/staff/purchase_log/update_submit',
		data:{
			"id":'${data.id}',
			"name":name,
			"gg":gg,
