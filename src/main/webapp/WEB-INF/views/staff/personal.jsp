						...
						<div class="table-responsive">
							<table class="table  table-striped table-bordered  table-hover">
								...
								<tbody id="detailBody">
									<tr>
										<th width="10%">员工号</th>
										<th width="90%"  >${detail.staffMsg.staffNo}</th>
									</tr>
									<tr>
										<th width="10%">姓名</th>
										<th width="90%"  >${detail.staffMsg.realName}</th>
									</tr>
									<tr>
										<th width="10%">联系电话</th>
										<th width="90%"  >${detail.staffMsg.celPhone}</th>
									</tr>
									<tr>
										<th width="10%">邮箱</th>
										<th width="90%"  >${detail.staffMsg.email}</th>
									</tr>
									<tr>
										<th width="10%">权限类型</th>
										<th width="90%"  >${detail.staffTypeStr}</th>
									</tr>
									<tr>
										<th width="10%">创建时间</th>
										<th width="90%"  >${detail.staffMsg.createTime}</th>
									</tr>
								</tbody>
							</table>
						</div>
						<div class="row"  style="margin-top:5px;margin-left:10%">
							<a href="${pageContext.request.contextPath}/staff/staff_msg/update1?id=${detail.staffMsg.id}" class="btn btn-success">修改</a>
						</div>
					</div>
				</div>
			</div>
