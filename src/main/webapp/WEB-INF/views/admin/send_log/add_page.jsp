...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=3590"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/send_log/add_submit',
		data:{
			"title":title,
			"psIntro":psIntro,
			"address":address,
