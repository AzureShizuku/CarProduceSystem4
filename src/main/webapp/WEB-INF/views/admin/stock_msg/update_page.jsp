...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1682"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/stock_msg/update_submit',
		data:{
			"id":'${data.id}',
			"proNo":proNo,
			"proName":proName,
