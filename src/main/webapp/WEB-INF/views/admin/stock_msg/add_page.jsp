...
<title>新增-库存台账</title>
<meta name="keywords" content="新增-库存台账">
<meta name="description" content="新增-库存台账">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="proNoParentContent">
								...
								<input type="text" value="" placeholder="请输入商品编号" id="proNo" class="form-control">
							</div>
							<div class="form-group" id="proNameParentContent">
								<label>商品名<span style="color:red">(*必填)</span></label>
								<input type="text" value="" placeholder="请输入商品名" id="proName" class="form-control">
							</div>
							...
							<div class="form-group" id="priceParentContent">
								...
								<input type="text" value="" placeholder="请输入单价(请输入数字)" id="price" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=0430"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/stock_msg/add_submit',
		data:{
			"proNo":proNo,
			"proName":proName,
			"gg":gg,
		...
		success: function(result) {
			if(result.code == 0){
				...
				alert(result.msg);
				window.location.href="${pageContext.request.contextPath}/admin/stock_msg";
			}
		}
	});
}
