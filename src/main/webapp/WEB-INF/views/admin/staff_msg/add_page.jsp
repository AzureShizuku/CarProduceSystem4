					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="staffNoParentContent">
								...
								<input type="text" value="" placeholder="请输入员工号" id="staffNo" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=0433"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/staff_msg/add_submit',
		data:{
			"staffNo":staffNo,
			"password":password,
			"realName":realName,
