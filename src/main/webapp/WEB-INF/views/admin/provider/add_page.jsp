...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4384"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/provider/add_submit',
		data:{
			"loginName":loginName,
			"password":password,
			"celPhone":celPhone,
