...
<title>修改-供应商</title>
<meta name="keywords" content="修改-供应商">
<meta name="description" content="修改-供应商">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=7786"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/provider/update_submit',
		data:{
			"id":'${data.id}',
			"loginName":loginName,
			"password":password,
		...
		success: function(result) {
			if(result.code == 0){
				...
				alert(result.msg);
				window.location.href="${pageContext.request.contextPath}/admin/provider";
			}
		}
	});
}
