			...
			<ul class="nav" id="side-menu">
				...
				<li>
					...
					<ul class="nav nav-second-level">
						<li>
							<a  href="javascript:void(0)" onclick="gotoPage(this)" data-url="${pageContext.request.contextPath}/provider/provider/detail" >个人信息 </a>
						</li>
					</ul>
					</li><li>
					...
					<ul class="nav nav-second-level">
						<li>
							<a  href="javascript:void(0)" onclick="gotoPage(this)" data-url="${pageContext.request.contextPath}/provider/purchase_log" >订货单 </a>
						</li>
					</ul>
				</li>
			</ul>
	...
	<div id="page-wrapper" class="gray-bg dashbard-1" style="min-height: 935px;">
		...
		<div class="row" >
			<div class="content" style="width:100%;">
				<iframe  id="iframeDom" style="position:absolute; width: 100%; height:835px; top: 0;border:0px ;margin-top:60px"   src="${pageContext.request.contextPath}/provider/provider/detail"></iframe>
			</div>
			<div class="footer">
				<div>
