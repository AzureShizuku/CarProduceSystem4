						...
						<div class="table-responsive">
							<table class="table  table-striped table-bordered  table-hover">
								...
								<tbody id="detailBody">
									<tr>
										<th width="10%">登录名</th>
										<th width="90%"  >${detail.provider.loginName}</th>
									</tr>
									<tr>
										<th width="10%">联系电话</th>
										<th width="90%"  >${detail.provider.celPhone}</th>
									</tr>
									<tr>
										<th width="10%">邮箱</th>
										<th width="90%"  >${detail.provider.email}</th>
									</tr>
									<tr>
										<th width="10%">地址</th>
										<th width="90%"  >${detail.provider.address}</th>
									</tr>
									<tr>
										<th width="10%">备注</th>
										<th width="90%"  >${detail.provider.remark}</th>
									</tr>
									<tr>
										<th width="10%">创建时间</th>
										<th width="90%"  >${detail.provider.createTime}</th>
									</tr>
									<tr>
										<th width="10%">供应商等级</th>
										<th width="90%"  >${detail.gysdjStr}</th>
									</tr>
								</tbody>
							</table>
						</div>
