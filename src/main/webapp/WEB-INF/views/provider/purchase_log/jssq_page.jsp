...
<title>接受申请-订货单</title>
<meta name="keywords" content="接受申请-订货单">
<meta name="description" content="接受申请-订货单">
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="checkRemarkParentContent">
								<label>审核备注<span style="color:red">(*必填)</span></label>
								<input type="text" value="${data.checkRemark}" placeholder="请输入审核备注" id="checkRemark" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=6270"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/provider/purchase_log/jssq_submit',
		data:{
			"id":'${data.id}',
		...
		success: function(result) {
			if(result.code == 0){
				...
				alert(result.msg);
				window.location.href="${pageContext.request.contextPath}/provider/purchase_log";
			}
		}
	});
}
