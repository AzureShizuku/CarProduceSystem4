...
<title>拒绝申请-订货单</title>
<meta name="keywords" content="拒绝申请-订货单">
<meta name="description" content="拒绝申请-订货单">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=5449"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/provider/purchase_log/jjsq_submit',
		data:{
			"id":'${data.id}',
